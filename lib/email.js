...
export async function sendPriceDropAlert(
    ...
    try {
        ...
        const { data, error } = await resend.emails.send({
            ...
            to:userEmail,
            subject: `Deal Drop Alert!!: ${product.name} `,
            html:`
            <!DOCTYPE html>
        <html>
          <head>
          ...
          <body style="font-family: Geist_Mono,-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
            
            <div style="background: black; padding: 30px; border-radius: 10px 10px 0 0; text-align: center;">
            ...
            <div style="background: #ffffff; padding: 30px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 10px 10px;">
              ...
              <div style="background: black; border-left: 4px solid red; padding: 15px; margin: 20px 0; border-radius: 4px;">
                <p style="margin: 0; font-size: 14px; color: #ffff;">
              ...
              <table style="width: 100%; margin: 20px 0;">
                ...
                <tr>
                  <td style="padding: 10px;">
                    ...
                    <div style="font-size: 32px; color: #FA5D1; font-weight: bold;">
              ...
              <div style="text-align: center; margin: 30px 0;">
                <a href="${product.url}" 
                   style="display: inline-block; background: black; color: white; padding: 14px 30px; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 16px;">
                  View Product →
                </a>
              </div>
